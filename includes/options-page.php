<div class="wrap vncheckout-settings-wrap vncheckout-modern-wrap">
    <div class="vncheckout-header">
        <h1><?php esc_html_e('Vietnam Address Woocommerce', 'vietnam-address-woocommerce'); ?></h1>
        <p class="vncheckout-header-desc">
            <?php esc_html_e('Fine-tune how Vietnamese addresses, currency conversion and advanced checkout helpers behave in your store.', 'vietnam-address-woocommerce'); ?>
        </p>
    </div>
    ...
    <div class="vncheckout-tabs">
        <nav class="vncheckout-tabs-nav">
            <a href="#tab-address" class="vncheckout-tab active" data-tab="address">
                ...
                <?php esc_html_e('Address', 'vietnam-address-woocommerce'); ?>
            </a>
            <a href="#tab-currency" class="vncheckout-tab" data-tab="currency">
                <span class="vncheckout-tab-icon">💰</span>
                <?php esc_html_e('Currency & Shipping', 'vietnam-address-woocommerce'); ?>
            </a>
            <a href="#tab-checkout" class="vncheckout-tab" data-tab="checkout">
                <span class="vncheckout-tab-icon">🛒</span>
                <?php esc_html_e('Checkout Fields', 'vietnam-address-woocommerce'); ?>
            </a>
            <a href="#tab-orders" class="vncheckout-tab" data-tab="orders">
                <span class="vncheckout-tab-icon">📦</span>
                <?php esc_html_e('Order Management', 'vietnam-address-woocommerce'); ?>
            </a>
        </nav>
        ...
        if (isset($_POST['save_vncheckout_settings']) && check_admin_referer('vncheckout_settings_nonce')) {
            $option_name = 'coolbirdzik_woo_district';
            $current_options = get_option($option_name, array());
            
            // Handle array-style inputs like coolbirdzik_woo_district[address_schema]
            foreach ($_POST as $key => $value) {
                if ($key === $option_name && is_array($value)) {
                    $current_options = array_merge($current_options, $value);
                } elseif (strpos($key, $option_name) === 0) {
                    // Handle other direct options
                    $current_options[$key] = $value;
                }
            }
            
            update_option($option_name, $current_options);
            echo '<div class="notice notice-success is-dismissible"><p>' . __('Settings saved!', 'vietnam-address-woocommerce') . '</p></div>';
        }
        ?>
        <form method="post" action="" novalidate="novalidate" class="vncheckout-settings-form">
            ...
            <div id="tab-address" class="vncheckout-tab-content active">
                <div class="vncheckout-card">
                    <div class="vncheckout-card-header">
                        <h2><?php esc_html_e('Vietnam Address Layout', 'vietnam-address-woocommerce'); ?></h2>
                        <p><?php esc_html_e('Choose how provinces, districts and wards are shown on checkout and account pages.', 'vietnam-address-woocommerce'); ?></p>
                    </div>
                    <div class="vncheckout-card-body">
                        <div class="vncheckout-field">
                            <label for="address_schema"><?php _e('Address Format', 'vietnam-address-woocommerce'); ?></label>
                            <div class="vncheckout-radio-group">
                                <label class="vncheckout-radio">
                                    ...
                                    <span class="vncheckout-radio-content">
                                        <strong><?php _e('Old Format', 'vietnam-address-woocommerce'); ?></strong>
                                        <small><?php _e('Province/City → District → Ward/Commune', 'vietnam-address-woocommerce'); ?></small>
                                    </span>
                                </label>
                                <label class="vncheckout-radio">
                                    <input type="radio" name="<?php echo $this->_optionName ?>[address_schema]" value="new" <?php checked('new', $flra_options['address_schema']); ?> />
                                    <span class="vncheckout-radio-content">
                                        <strong><?php _e('New Format', 'vietnam-address-woocommerce'); ?></strong>
                                        <small><?php _e('Province/City → Ward/Commune (District hidden)', 'vietnam-address-woocommerce'); ?></small>
                                    </span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Hide Ward/Commune Field', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Hide Ward/Commune/Town field in checkout form. Default is shown.', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Ward/Commune is NOT Required', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('When Ward/Commune field is shown, it is optional.', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                    </div>
            ...
            <div id="tab-currency" class="vncheckout-tab-content">
                <div class="vncheckout-card">
                    <div class="vncheckout-card-header">
                        <h2><?php esc_html_e('Currency & Conversion', 'vietnam-address-woocommerce'); ?></h2>
                        <p><?php esc_html_e('Control currency formatting, volumetric weight and VNĐ ↔ foreign currency conversion.', 'vietnam-address-woocommerce'); ?></p>
                    </div>
                    <div class="vncheckout-card-body">
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Convert ₫ to VNĐ', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Allow conversion to VNĐ', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>

                        <div class="vncheckout-field">
                            <label for="khoiluong_quydoi"><?php _e('Conversion Quotient', 'vietnam-address-woocommerce'); ?></label>
                            ...
                            <small><?php _e('Default by Viettel Post is 6000', 'vietnam-address-woocommerce'); ?></small>
                        </div>
                    </div>
                </div>
                ...
                <div class="vncheckout-card">
                    <div class="vncheckout-card-header">
                        <h2><?php esc_html_e('PayPal Conversion', 'vietnam-address-woocommerce'); ?></h2>
                        <p><?php esc_html_e('Enable VNĐ to foreign currency conversion to use PayPal.', 'vietnam-address-woocommerce'); ?></p>
                    </div>
                    <div class="vncheckout-card-body">
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Enable VNĐ to USD Conversion', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Enable VNĐ to USD conversion to use PayPal', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="vncheckout-field-row">
                            <div class="vncheckout-field">
                                <label for="vnd2usd_currency"><?php _e('Target Currency', 'vietnam-address-woocommerce'); ?></label>
                            ...
                            <div class="vncheckout-field">
                                <label for="vnd_usd_rate"><?php _e('Exchange Rate', 'vietnam-address-woocommerce'); ?></label>
                                ...
                                <small><?php _e('Exchange rate from VNĐ', 'vietnam-address-woocommerce'); ?></small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="vncheckout-card">
                    <div class="vncheckout-card-header">
                        <h2><?php esc_html_e('Shipping Options', 'vietnam-address-woocommerce'); ?></h2>
                        <p><?php esc_html_e('Configure shipping method display options.', 'vietnam-address-woocommerce'); ?></p>
                    </div>
                    <div class="vncheckout-card-body">
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Remove Shipping Title', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Completely remove shipping method title', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Hide Methods When Free Shipping Available', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Hide all other shipping methods when free shipping is available', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                    </div>
            ...
            <div id="tab-checkout" class="vncheckout-tab-content">
                <div class="vncheckout-card">
                    <div class="vncheckout-card-header">
                        <h2><?php esc_html_e('Alepay & Billing Fields', 'vietnam-address-woocommerce'); ?></h2>
                        <p><?php esc_html_e('Configure additional billing fields required by Alepay and other gateways.', 'vietnam-address-woocommerce'); ?></p>
                    </div>
                    <div class="vncheckout-card-body">
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Show First Name Field', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Required for Alepay payment.', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Show Country Field', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Required for Alepay payment.', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                        ...
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Show Postcode Field', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Required for Alepay Tokenization payment.', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                    </div>
            ...
            <div id="tab-orders" class="vncheckout-tab-content">
                <div class="vncheckout-card">
                    <div class="vncheckout-card-header">
                        <h2><?php esc_html_e('Order Management', 'vietnam-address-woocommerce'); ?></h2>
                        <p><?php esc_html_e('Extra filters for quickly finding orders by province and date.', 'vietnam-address-woocommerce'); ?></p>
                    </div>
                    <div class="vncheckout-card-body">
                        <div class="vncheckout-field">
                            <label class="vncheckout-toggle">
                                ...
                                <span class="vncheckout-toggle-slider"></span>
                                <span class="vncheckout-toggle-label">
                                    <strong><?php _e('Enable Order Filter', 'vietnam-address-woocommerce'); ?></strong>
                                    <small><?php _e('Enable filter by province and date in order list page', 'vietnam-address-woocommerce'); ?></small>
                                </span>
                            </label>
                        </div>
                    </div>
            ...
            <div class="vncheckout-submit">
                <?php submit_button(__('Save Changes', 'vietnam-address-woocommerce'), 'primary vncheckout-btn-primary', 'save_vncheckout_settings', false); ?>
            </div>
        </form>
    </div>
</div>
